        ...
        void *callbackContext)       /**< Timer module Context. */
{
    ...
    if (stack_ctx->dpmConfig.attach)
    {
        ...
        if (stack_ctx->dpmConfig.contractExist)
        {
            ...
            srcType[stack_ctx->port] = PD_POWER_SOURCE;
        }
        else
        {
#if BATTERY_CHARGING_ENABLE
...
#endif /* BATTERY_CHARGING_ENABLE */
            {
                ...
                srcType[stack_ctx->port] = SDP_SOURCE;
            }
        }
    ...
    else
    {
        ...
        srcType[stack_ctx->port] = TYPE_C_DISCONNECT;
    }
}
...
int main(void)
{
    ...
    /* Setting the initial states for LCD */
    lcd_print_state = LCD_START;
