...
APPNAME=mtb-example-pmg1-usbpd-sink-lcd-display
...
DEFINES=CY_PD_SINK_ONLY=1 CY_PD_REV3_ENABLE=1 VBUS_OVP_ENABLE=1 VBUS_UVP_ENABLE=0 SYS_DEEPSLEEP_ENABLE=0 BATTERY_CHARGING_ENABLE=1 \
